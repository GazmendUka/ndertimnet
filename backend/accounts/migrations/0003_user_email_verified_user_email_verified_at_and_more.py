# Generated by Django 5.2.7 on 2025-12-15 06:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_customer_consent_job_publish_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_used'], name='accounts_em_user_id_33bc9c_idx'), models.Index(fields=['expires_at'], name='accounts_em_expires_f36bd3_idx')],
            },
        ),
    ]
